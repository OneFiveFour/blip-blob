...
import net.onefivefour.sessiontimer.core.usecases.session.SetSessionSortOrdersUseCaseImpl
...
internal interface SessionModule {
    ...
    @Binds
    @ViewModelScoped
    fun bindSetSessionSortOrdersUseCase(
        impl: SetSessionSortOrdersUseCaseImpl
